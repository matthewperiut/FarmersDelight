...
{
	public static LazyRegistrar<Codec<? extends BiomeModifier>> BIOME_MODIFIER_SERIALIZERS =
			LazyRegistrar.create(ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, FarmersDelight.MODID);
